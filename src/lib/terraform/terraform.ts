...
import { BehaviourObjectChildrenInterface, BehaviourObjectInterface } from "../interfaces/behaviour-object.interface";
...
export class Terraform {
	private _currentState: TerraformStateInterface | null = null;
	...
	loadState(state: TerraformStateInterface) {
	...
	private loadObj3D(behaviourObject3D: BehaviourObjectInterface<Object3D>, gltfLoader: GLTFLoader) {
	...
	private loadChildren(currObj: BehaviourObjectInterface<Object3D<Object3DEventMap>>, child: BehaviourObjectChildrenInterface<Object3D<Object3DEventMap>>) {
	...
	private loadLight(behaviourLight: BehaviourObjectInterface<Light>) {
